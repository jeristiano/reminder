<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-16 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('publish') }}" :active="request()->routeIs('publish')">
                ...
                <div class="hidden sm:-my-px sm:ml-80 sm:flex items-center justify-end space-x-8">
                    <x-jet-input placeholder="search" class="text-lg text-gray-600 lg:px-4 h-8
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <x-jet-dropdown-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}">
                                        {{ __('dashboard.Team Settings') }}
                                    </x-jet-dropdown-link>

                                    @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                                        <x-jet-dropdown-link href="{{ route('teams.create') }}">
                                            {{ __('dashboard.Create New Team') }}
                                        </x-jet-dropdown-link>
                                    @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('publish') }}" :active="request()->routeIs('publish')">
                {{ __('dashboard.publish') }}
            </x-jet-responsive-nav-link>
