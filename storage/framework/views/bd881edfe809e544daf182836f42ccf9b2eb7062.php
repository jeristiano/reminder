    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="px-4 py-5 sm:px-6 bg-green-500">
            <h3 class="text-lg leading-6 font-medium text-white">
                <a class="hover:text-gray-500" href="<?php echo e(route('tags')); ?>"
                   title="所有标签">标签</a>
            ...
            <p class="mt-4 max-w-2xl text-sm text-white">
                当前共有标签: <?php echo e($tags->count()); ?> 个！
                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="text-white  bg-red-400 ml-1 leading-5 rounded-sm"> <?php echo e($tag); ?>
                                ...
                                <div class="px-5 py-6 bg-gray-200 text-gray-700 border-b">
                                    <div class="mt-2 relative rounded-md ">
                                        ...
                                        <input wire:model.lazy="name"  type="text"
                                               wire.attributes.value="<?php echo e($tagModel->name); ?>"
...
<?php /**PATH /data/webroot/www/evenote/resources/views/livewire/tags-edit.blade.php ENDPATH**/ ?>